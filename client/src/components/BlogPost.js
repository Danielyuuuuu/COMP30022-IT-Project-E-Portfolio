      ...
      <div className="blogPost">
        <Card body>
          <CardImg
            ...
            alt="Card image cap"
          />
          <CardFooter className="blogText">Architecture</CardFooter>
        </Card>
        ...
        <Card body>
          <CardImg
            ...
            alt="Card image cap"
          />
          <CardFooter className="blogText">Photography</CardFooter>
        </Card>
        ...
        <Card body>
          <CardImg
            ...
            alt="Card image cap"
          />
          <CardFooter className="blogText">Art Product</CardFooter>
        </Card>
        ...
        <Card body>
          <CardImg
            ...
            alt="Card image cap"
          />
          <CardFooter className="blogText">Painting</CardFooter>
        </Card>
      </div>
    );
  }
